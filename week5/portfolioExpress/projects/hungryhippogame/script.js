(function () {
    ...
    function generateRandomNum() {
        //generate random number to change elements position
    ...
    board.addEventListener("click", function () {
        //añado el eventlistener, como la img es position absolute va a escuchar el click en toda la pantalla
    ...
    melonBtn.addEventListener("click", function (event) {
        //the same function but only in the button
        melonPos += generateRandomNum();
    ...
    document.addEventListener("keydown", function (event) {
        if (event.keyCode === 68) {
            //escucho si presion la letra d(codigo 68)
